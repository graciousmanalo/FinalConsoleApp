...
namespace FinalConsoleApp
{
    public class Instructor:Person
    {
        ...
        private string _rank; //private field (Encapsulation - data hiding)
        ...
        public string Rank
        {
            ...
            set
            {
                _rank = value; //value is a default for getter & setter
            }
        }
        ...
        private static int YearsOfWork(DateTime HireDate)
        {
            ...
            if (HireDate.AddYears(yrsExp) > now) //cannot be greater than now(2018)
                yrsExp--; 
